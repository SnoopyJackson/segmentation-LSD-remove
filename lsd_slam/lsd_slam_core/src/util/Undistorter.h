...
//class UndistorterCLAMS : public Undistorter
//{
//    UndistorterCLAMS(const char* configFileName);
...
//    UndistorterCLAMS(const UndistorterOpenCV&) = delete;
//    UndistorterCLAMS& operator=(const UndistorterOpenCV&) = delete;
