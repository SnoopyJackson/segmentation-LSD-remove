...
//UndistorterCLAMS::UndistorterCLAMS(const char* configFileName)
//{
//    valid = true;
////    // read parameters
////    std::ifstream infile(configFileName);
////    assert(infile.good());
//    _distortionModel.load("my_model");

//}
//UndistorterCLAMS::~UndistorterCLAMS()
//{
//}
//void UndistorterCLAMS::undistort(const cv::Mat& image, cv::OutputArray result) const
//{
